...
struct LuluNameCardFront: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ContactRow(text: contact.email, icon: "envelope.fill")
                ContactRow(text: contact.phone, icon: "phone.fill")
                ContactRow(text: contact.address, icon: "location.fill")
