...
struct LuluView: View {
    ...
    static let contact: Contact = Contact(
        ...
        email: "D1397221@o365.fcu.edu.tw",
        phone: "+886-888-888-888",
        address: "Taichung, Taiwan",
        website: "github.com/XXX",
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                if !isFlipped {
                    // Front of card
                    LuluNameCardFront(contact: LuluView.contact, triggerAnimation: !isFlipped, animationResetTrigger: animationResetTrigger)
                        .opacity(isFlipped ? 0 : 1)
                } else {
                    // Back of card
                    LuluNameCardBack(contact: LuluView.contact, triggerAnimation: isFlipped, animationResetTrigger: animationResetTrigger)
